          ...
          <main className="pa3 pa4-m pa4-l black-80">
            <form className="measure center" onSubmit={this.handleSubmit}>
              <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
                ...
                <div className="mt3">
                  <label className="db fw2 lh-copy f6" htmlFor="email">
                    Email
                  </label>
                  <input
                ...
                <div className="mv3">
                  <label className="db fw2 lh-copy f6" htmlFor="password">
                    Password
                  </label>
                  <input
              ...
              <div className="lh-copy mt3">
                <Link
                  to="/register"
                  className="pointer fw2 f6 link dim black db"
                >
                  Don't have an account yet?{' '}
                  <span className="underline">Register</span>
                </Link>
                <a href="#0" className="f6 fw2 link dim black db">
